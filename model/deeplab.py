...
class ResNet(nn.Module):
    def __init__(self, block, layers, num_classes):
        ...
        # H_{out} = floor((H_{in}+2*3-(7-1) - 1) / 2 + 1)
        # W_{out} = floor((W_{in}+2*3-(7-1) - 1) / 2 + 1)
        ...
        # $$H_{out} = floor((H_{in} + 2 - (3 - 1) - 1) / 2 + 1$$
        # $$W_{out} = floor((W_{in} + 2 - (3 - 1) - 1) / 2 + 1$$
